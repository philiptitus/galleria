...
class Follower(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='followers', default=1, on_delete=models.CASCADE)
...
class Following(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='following', default=1, on_delete=models.CASCADE)
