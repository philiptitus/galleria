...
class CustomUser(AbstractUser):
    ...
    avi = models.URLField(null=True, blank=True ,default='https://izpkijnmscmbolveusoo.supabase.co/storage/v1/object/public/Galleria/pfp/avatar-19-svgrepo-com.png')
...
from base.storage import SupabaseStorage  # Import your custom storage backend
...
class PostImage(models.Model):
    ...
    album = models.URLField(null=True, blank=True)
