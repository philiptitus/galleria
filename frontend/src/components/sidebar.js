...
//                     <a href="#"><li><i className="fas fa-camera"></i>Home</li></a>
//                     <Link to='/galleria'><a><li><i className="fas fa-photo"></i>Galleria</li></a></Link>
//                     <Link to='/slices'><a><li><i className="fas fa-film"></i>Slices</li></a></Link>

//                     <Link to='/search'><a><li><i className="fas fa-search"></i>Search</li></a></Link>
//                     <Link to='/chat'><a><li><i className="fas fa-envelope"></i>Chat</li></a></Link>
...
//           <Link to='/login'><a><li><i className="fas fa-sign-in-alt"></i>Log In</li></a></Link>
//           </ul>
//         )}
