...
import UpdatePostPopup from './UpdatePostPopup'; // Import the new component
...
export default function Post({image, date, caption, description, total_likes, total_bookmarks, total_comments, avi, name, id, user, card = true, screen = false, showFollow = false, likers, currentUserEmail, bookers, poster}) {
  ...
  return (
    <Row style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      >
          ...
          action={
            <>
              ...
              >
                ...
                >
                  {userInfo?.id == user &&
                    <MenuItem onClick={() => deletePostHandler(id)} style={{color:"red"}}>Delete Post</MenuItem>
                  }
                </Row>
                <Row
                  style={{
                ...
                >
                  {userInfo?.id == user &&
                    <MenuItem onClick={handleOpenUpdatePopup} style={{color:"green"}}>Update Post</MenuItem>
                  }
                </Row>
              </Menu>
            </>
        ...
        <CardActions disableSpacing>
          <IconButton aria-label="add to favorites" onClick={HandleLike}>
            {isCurrentUserLiker &&  <Liker total={total_likes} red={true} />}
            {!isCurrentUserLiker && <Liker total={total_likes} />}
          </IconButton>
          <IconButton aria-label="share"  onClick={HandleBookmark}>
            {isCurrentUserBooker &&  <Liker total={total_bookmarks} red={true} bookmark={true} />}
            {!isCurrentUserBooker && <Liker total={total_bookmarks} bookmark={true} />}
          </IconButton>
      ...
      {openUpdatePopup && <UpdatePostPopup postId={id} open={openUpdatePopup} handleClose={handleCloseUpdatePopup} p_caption={caption} p_description={description} />}
    </Row>
  );
}
